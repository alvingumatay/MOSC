  ...
  <div class="row">
		<div class = "panel panel-success">	
			<div class = "panel-heading">
				...
				<a style = "float:right; margin-top:-4px;" href = "patient.php" class = "btn btn-success"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
			</div>
			...
			?>
				<form method = "POST" enctype = "multipart/form-data">
					<div style = "float:left;" class = "form-inline">
						...
						<input class = "form-control" size = "50px;" value = "<?php echo $f['email'] ?>"  name = "email" required=
						"required"/> 
						 &nbsp;&nbsp;&nbsp;
						<label for = "password">Password:</label>
						<input type="password" class = "form-control" value = "<?php echo $f['password'] ?>" id="myInput"  name = "password" required=
						"required"/>
						&nbsp;&nbsp;&nbsp;
				   ...
				   <br />
					...
					<div class = "form-group">
						...
						<input class = "form-control" style = "width:20%;" value = "<?php echo $f['contact']?>" name = "contact" type = "text">
						<br />
		...
		<input class = "form-control" style = "width:20%;" value = "<?php echo $f['civil_status']?>" name = "civil_status" type = "text" required = "required">
						...
						<select style = "width:22%;" class = "form-control"  name = "gender" value="<?php echo $f['gender'] ?>">
