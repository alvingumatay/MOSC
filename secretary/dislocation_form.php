...
<body>
  ...
  <div class="row">
		<?php
			...
			?>
			<br />
		<div class = "alert alert-success">Basic Information <a class = "btn btn-success" style = "float:right; margin-top:-7px;" href = "dislocation_record.php?itr_no=<?php echo $f['itr_no']?>">
