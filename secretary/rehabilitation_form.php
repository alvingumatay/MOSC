...
<body>
 ...
 <br/><br/><br/><br/><br/>
  ...
  <div class="container-fluid">
		...
		<div class = "alert alert-success">Basic Information <a class = "btn btn-success" style = "float:right; margin-top:-7px;" href = "rehabilitation_record.php?itr_no=<?php echo $f['itr_no']?>">
