...
<body>
  ...
  <div class="row">
		...
		<div class = "alert alert-success">Fecalysis Record / <?php echo $f1['firstname']." ".substr($f1['middlename'], 0, 1).". ".$f1['lastname']?>
			<a class = "btn btn-success" style = "float:right; margin-top:-7px;" href = "fecalysis.php">
		...
		<table id = "table" cellspacing = "0" class = "display">
			...
			?>
				<tr>
					...
					<td><center><a href = "fecalysis_form.php?itr_no=<?php echo $f['itr_no']?>&fecalysis_id=<?php echo $f['fecalisys_id']?>" class = "btn btn-success"><span class = "glyphicon glyphicon-search"></span> View Detail</a><center></td>
				</tr>
			<?php
				}
			?>	
