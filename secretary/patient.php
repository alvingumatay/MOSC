  ...
  <center><p>Touch Screen left,right,up,down to see details.</p></center>
    <div style = "display:none;" id = "add_itr" class = "panel panel-success"> 
      ...
      <div class = "panel-body">
        ...
        <form id = "form_dental"  action="add_patient" method = "POST" enctype = "multipart/form-data">
          ...
          <div class = "form-group">
            ...
            <input class = "form-control" style = "width:20%;" min = "0" max = "999" name = "contact" type = "text">
            <br/>
