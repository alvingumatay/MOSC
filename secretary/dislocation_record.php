...
<body>
  ...
  <div class="row">
		...
		<div class = "alert alert-success">Dislocation Record / <?php echo $f1['firstname']." ".substr($f1['middlename'], 0, 1).". ".$f1['lastname']?><a class = "btn btn-success" style = "float:right; margin-top:-7px;" href = "minor_surgery.php"><span class = "glyphicon glyphicon-hand-right"></span> Back</a>
		</div>
