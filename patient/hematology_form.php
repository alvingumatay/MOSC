...
<br/><br/><br/><br/><br/><br/><br/><br/>
  <div class="ts-main-content">
		...
		<?php
			...
			$f = $q->fetch_array();
		?>
		<div class = "alert alert-success">Basic Information<a class = "btn btn-success" style = "float:right; margin-top:-7px;" href = "hematology_record.php?itr_no=<?php echo $f['itr_no']?>"><span class = "glyphicon glyphicon-hand-right"></span> Back</a></div>
