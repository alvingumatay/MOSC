	...
	<div class = "panel panel-success">
            ...
            <center>
				<div class="dash">
					...
					<a href="patient.php" style="pointer-events: unset;">
						<label style="background-color: dodgerblue; cursor: pointer;"><i class="glyphicon glyphicon-user"></i>
							
							<?php 
	
								$qpatient = $conn->query("SELECT COUNT(itr_no) AS total FROM `itr`") or die(mysqli_error());
								$fpatient = $qpatient->fetch_array();
								$num_rows = $fpatient['total'];
					...
					<a href="user.php">
						<label style="background-color: dodgerblue; cursor: pointer;"><i class="glyphicon glyphicon-plus"></i>
							<?php 
								...
								$qdoctor = $conn->query("SELECT COUNT(user_id) AS total FROM `user`") or die(mysqli_error());
								$fdoctor = $qdoctor->fetch_array();
								$num_rows = $fdoctor['total'];
						...
						<label style="background-color: dodgerblue; cursor: pointer;"><i class="glyphicon glyphicon-user"></i>
							<?php 
								...
								$qsecretary = $conn->query("SELECT COUNT(sec_id) AS total FROM `secretary`") or die(mysqli_error());
								$fsecretary = $qsecretary->fetch_array();
								$num_rows = $fsecretary['total'];
						...
						<label style="background-color: dodgerblue; cursor: pointer;"><i class="glyphicon glyphicon-user"></i>
							...
							<?php 
								...
								$qapp = $conn->query("SELECT COUNT(itr_no) AS total FROM `appointment` WHERE `status` = 'pending'") or die(mysqli_error());
