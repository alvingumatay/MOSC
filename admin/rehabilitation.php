      ...
      <?php require 'script.php'?>
		...
		window.onload = function(){ 
			$(".chartContainer").CanvasJSChart({ 
				title: { 
					text: "Monthly Consultation Patient Population <?php echo $year?>" 
				}, 
				axisY: { 
...
<?php include('includes/header.php');?>
 <br/><br/><br/><br/>
  ...
  <div class="row">
		...
		<br />
		<div id = "target">
			<div class = "alert alert-success">Consultation Record</div>
			<table id = "table" cellspacing = "0" class = "display">
				...
				?>
					<tr>
						...
						<td><center><a class = "btn btn-success" href = "rehabilitation_record.php?itr_no=<?php echo $fetch['itr_no']?>"><span class = "glyphicon glyphicon-search"></span> All Records</a></center></td>
					</tr>
				<?php
					}
				?>		
