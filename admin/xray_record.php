...
<body>
  ...
  <div class="row">
		...
		?>
		<br />
		<div class = "alert alert-success">Xray Record / <?php echo $f1['firstname']." ".substr($f1['middlename'], 0, 1).". ".$f1['lastname']?>
		<a class = "btn-sm btn-info" style = "float:right; margin-top:-7px;" href = "xray.php">
