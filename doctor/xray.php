...
<br/><br/><br/><br/><br/><br/><br/><br/>
  <div class="ts-main-content">
	<div class = "well">
		...
		<br/><br/>
		<a href = "view_xray_record.php" id = "d_record" style = "float:right; margin-right:10px;" class = "btn btn-danger"><span class = "glyphicon glyphicon-book"></span> XRAY RECORD</a>
		<br />
		<br />
		...
		<table id = "table" class = "display" cellspacing = "0" >
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<center>
							<a href = "view_xray.php?itr_no=<?php echo $fetch['itr_no']?>"class = "btn btn-sm btn-success">
