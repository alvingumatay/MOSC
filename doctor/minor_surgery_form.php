	...
	<div class = "panel panel-warning">
		...
		<div class = "panel panel-default">
			...
			<?php
				...
				$f = $q->fetch_array();
			?>
				<label>MINOR SURGERY RESULT FORM</label>

				<a style = "float:right; margin-top:-4px;" href = "minor_surgery_record.php?itr_no=<?php echo $f['itr_no']?>&surgery_id=<?php echo $f['surgery_id']?>" class = "btn-xs btn-info">
                <span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
				
                <a style = "margin-right:5px; float:right; margin-top:-4px;" href = "minor_surgery_print.php?itr_no=<?php echo $f['itr_no']?>&surgery_id=<?php echo $f['surgery_id']?>" class = "btn-xs btn-info">
                <span class = "glyphicon glyphicon-print"></span> PRINT</a>
			
                <a style = "margin-right:5px; float:right; margin-top:-4px;" href = "minor_surgery_print_medcert.php?itr_no=<?php echo $f['itr_no']?>&surgery_id=<?php echo $f['surgery_id']?>" class = "btn-xs btn-info">
			...
			<div class = "panel-body">
				...
				<div class = "form-inline">
					<center><h3 style = "color:#3C763D;"><u>MINOR SURGERY NOTES</u></h3></center>
				</div>
				<br />
