...
<br/><br/><br/><br/><br/><br/><br/><br/>
  <div class="ts-main-content">
	<div class = "well">
		...
		<br/><br/>
		<a href = "view_fecalysis_record.php" id = "d_record" style = "float:right; margin-right:10px;" href = "" class = "btn btn-danger"><span class = "glyphicon glyphicon-book"></span> FECALYSIS RECORD</a>
		<br />
		<br />
		...
		<table id = "table" class = "display" cellspacing = "0" >
			<thead>
				...
				<tr>
					...
					<td>
						<center>
							<a href = "view_fecalysis.php?itr_no=<?php echo $fetch['itr_no']?>"class = "btn btn-sm btn-success">
