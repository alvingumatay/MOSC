...
<html lang = "en">
  ...
  <div class="ts-main-content">
		...
		<a style = "float:right; margin-top:-4px;" href = "dislocation.php" class = "btn btn-success"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a> 
		<br />
		<br />
		<div class = "panel panel-success">
			<div class = "panel-heading">
				<h4>DISLOCATION RECORD LIST</h4>
			</div>
		</div>
		<br />
		<table id = "table" cellspacing = "0" class = "display">
			...
			<?php 
				$conn = new mysqli("localhost","root","","hcpms") or die(mysqli_error());
				$q = $conn->query("SELECT * FROM `dislocation` NATURAL JOIN `itr` GROUP BY `itr_no` ORDER BY `dislocation_id` DESC") or die(mysqli_error());
			...
			?>
				<tr>
					...
					<td><center>
							<a href = "dislocation_record.php?itr_no=<?php echo $f['itr_no']?>&dislocation_id=<?php echo $f['dislocation_id'] ?>"class = "btn btn-success"><span class = "glyphicon glyphicon-book"></span> All Record</a> 
						</center></td>
				</tr>
			<?php
				}
