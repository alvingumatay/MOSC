...
<br />
	<div id="print">
      <img src = "../images/mosc-logo.png" height = "100px" width = "100px" style = "float:left; position:relative; left:5%;" />
		<div style = "margin:10px;">
           
			<label style = "font-size:18px;"><center>MARIKINA ORTHOPEDIC SPECIALTY CLINIC</center></label>
			<label><center>DIAGNOSTIC LABORATORY</center></label>
