  ...
  <div class="ts-main-content">
	<div class = "well">
		...
		<div class = "panel panel-default">
			<div class = "panel-heading">
				<label>HEMATOLOGY RESULT FORM</label>	<a style = "float:right; margin-top:-4px;" href = "hematology_record.php?itr_no=<?php echo $_GET['itr_no']?>&hem_id=<?php echo $_GET['hem_id']?>" class = "btn btn-success"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
				<a style = "margin-right:5px; float:right; margin-top:-4px;" href = "hematology_print.php?itr_no=<?php echo $_GET['itr_no']?>&hem_id=<?php echo $_GET['hem_id']?>" class = "btn btn-success"><span class = "glyphicon glyphicon-print"></span> PRINT</a>
			</div>
