...
<br />
	<div id="print">
        ...
        <div style = "margin-right:0px;">
				...
				<label><center>National Capital Region</center></label>
				<label><center>LUNGSOD NG Marikina</center></label>
			...
			<br />
			<br />
			<label style = "font-weight:bold; letter-spacing: 2px;"><center>RADIOLOGICAL / ULTRASONOLOGICAL REPORT</center></label>
			<br />
			<br />
			<br />
			<br />
