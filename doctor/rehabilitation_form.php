  ...
  <div class="ts-main-content">
		...
		<div class = "panel panel-default">
			...
			?>
				...
				<a style = "float:right; margin-top:-4px;" href = "rehabilitation_record.php?itr_no=<?php echo $f['itr_no']?>&rehab_id=<?php echo $f['rehab_id']?>" class = "btn-sm btn-info">
                <span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
				
                <a style = "margin-right:5px; float:right; margin-top:-4px;" href = "rehabilitation_print.php?itr_no=<?php echo $f['itr_no']?>&rehab_id=<?php echo $f['rehab_id']?>" class = "btn-sm btn-info">
                <span class = "glyphicon glyphicon-print"></span> PRINT</a>
			
                <a style = "margin-right:5px; float:right; margin-top:-4px;" href = "rehabilitation_print_medcert.php?itr_no=<?php echo $f['itr_no']?>&rehab_id=<?php echo $f['rehab_id']?>" class = "btn-sm btn-info">
