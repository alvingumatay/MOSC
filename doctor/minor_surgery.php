...
<html lang = "en">
	<head>	
		<title>Minor Surgery | Patient Record System</title>
		<meta charset = "UTF-8">
  ...
  <div class="ts-main-content">
    <center><p>Touch Screen left,right,up,down to see details.</p></center>
		<div class = "panel panel-warning">
           ...
           <a style = "float:right; margin-top:-4px;" href = "doctor_appointment.php" class = "btn btn-success"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
            <br/><br/>	
		<a href = "view_minor_surgery_record.php" id = "d_record" style = "float:right; margin-right:10px;" class = "btn btn-danger"><span class = "glyphicon glyphicon-book"></span> MINOR SURGERY RECORD</a>
		<br />
		<br />
		...
		<table id = "table" class = "display" cellspacing = "0" >
			...
			?>
				<tr>
					...
					<td>
						<center>
							<a href = "view_minor_surgery.php?itr_no=<?php echo $fetch['itr_no']?>"class = "btn btn-sm btn-success">
