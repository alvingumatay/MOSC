...
<br/><br/><br/><br/><br/><br/><br/><br/>
  <div class="ts-main-content">
	<div class = "well">
		...
		<a style = "float:right; margin-top:-4px;" href = "view_xray_record.php?itr_no=<?php echo $_GET['itr_no']?>" class = "btn btn-success"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a> 
		<br />
		<br />
		...
		<table id = "table" cellspacing = "0" class = "display">
			...
			?>
				<tr>
					...
					<td>
					    <center>
					        <a class = "btn btn-success" href = "xray_form.php?itr_no=<?php echo $f['itr_no']?>&rad_id=<?php echo $f['rad_id']?>">
