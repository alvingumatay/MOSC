...
<html lang = "en">
  ...
  <div class="ts-main-content">
		...
		<a style = "float:right; margin-top:-4px;" href = "view_minor_surgery_record.php" class = "btn btn-success"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a> 
		<br />
		<br />
		<div class = "panel panel-success">
			...
			?>
			<div class = "panel-heading">
				<h4>Minor Surgery Record / <?php echo $f1['firstname']." ".$f1['lastname']?></h4>
			</div>
