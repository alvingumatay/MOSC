            ...
            <div class="well well-black">
                <hr>
                                <div class="section-title">
                                    <center><h4 style="font-weight:bold; color:gray;"><i class=" fontello-icon-docs"></i> Counter Xray </h4></center>
                                </div>
                <div class="row-fluid">
                        <div class="span4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="content/transaksi/restart.php" class="btn btn-success">Yes</a>
            </div>
        </div>
    </div>
</div>
