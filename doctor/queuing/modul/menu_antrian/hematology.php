...
if ($_SESSION[leveluser]=='admin' OR $_SESSION[leveluser]=='loket hematology' ){
            ...
            <div class="well well-black">
                <hr>
                                <div class="section-title">
                                    <center><h4 style="font-weight:bold; color:gray;"><i class=" fontello-icon-docs"></i> Counter Hematology </h4></center>
                                </div>
                <div class="row-fluid">
                        <div class="span4">
...
<script>
    $(document).ready(function() {
        $("#loader").hide(),
        $(".counter").load("respon/respon_hematology.php");
...
// rest of your code
    $.ajax({
         type: "POST",
         url: "content/hematology/counter.php",
         success: function (response) {
             $(".counter").show();
             $("#loader").hide();
             $(".counter").load("respon/respon_hematology.php",1)
         }
...
// rest of your code
        $.ajax({
             type: "POST",
             url: "content/hematology/back.php",
             success: function (response) {
                 $(".counter").show();
                 $("#loader").hide();
                 $(".counter").load("respon/respon_hematology.php",350);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="content/hematology/restart.php" class="btn btn-success">Yes</a>
            </div>
        </div>
    </div>
</div>
