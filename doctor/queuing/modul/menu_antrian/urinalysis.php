...
if ($_SESSION[leveluser]=='admin' OR $_SESSION[leveluser]=='loket urinalysis' ){
  

$detail = mysql_query("SELECT * FROM
                            loket
                            WHERE
                            nama_loket='URINALYSIS'");
            ...
            <div class="well well-black">
                <hr>
                                <div class="section-title">
                                    <center><h4 style="font-weight:bold; color:gray;"><i class=" fontello-icon-docs"></i> Counter Urinalysis </h4></center>
                                </div>
                <div class="row-fluid">
                        <div class="span4">
                        ...
                        <div class="span3">
                            <center><h6 style="font-weight:bold; color:gray;">Counter </h6>
                                <h1 class="well well-black well-small inline" ><br><span style="margin-top:10px; font-family:SimHei; font-size: 55px; font-weight:bold; color:#FFFF00;"><?php echo "$loket";?></span></h1></center>
                        </div>
                        <!-- // Column --> 
                        <div class="span5">
...
<script>
    $(document).ready(function() {
        $("#loader").hide(),
        $(".counter").load("respon/respon_urinalysis.php");
...
// rest of your code
    $.ajax({
         type: "POST",
         url: "content/urinalysis/counter.php",
         success: function (response) {
             $(".counter").show();
             $("#loader").hide();
             $(".counter").load("respon/respon_urinalysis.php",1)
         }
...
// rest of your code
        $.ajax({
             type: "POST",
             url: "content/urinalysis/back.php",
             success: function (response) {
                 $(".counter").show();
                 $("#loader").hide();
                 $(".counter").load("respon/respon_urinalysis.php",350);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Restart Queue No.</h4>
            </div>
            <div class="modal-body">
                <center><p>
Are You Sure You Want To Repeat This Queue?<br><br> <b>The queue will start from number "1"</b></p></center>
            </div>
            <div class="modal-footer">
                <a href="content/urinalysis/restart.php" class="btn btn-success">Yes</a>
            </div>
        </div>
    </div>
</div>
                                                ...
                                                <ul class="form-list">
                                                    <center>
                                                            <li class="control-group">
                                                                <label for="accountAddressState" class="control-label">No Queue Required: <span class="required">fill in the numbers *</span></label>
                                                                <div class="controls">
