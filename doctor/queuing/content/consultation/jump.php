...
session_start();
			...
			$_SESSION['antrian_loket2']   = "A$antrian";
                        //echo "$antrian";
                        include '../../config/database.php';
                        include '../../config/fungsi_zona.php';
                         mysql_query("UPDATE temp_consultation SET nomor_antrian='$antrian', 
                                        time='$wita'
                                        WHERE id = '1'");
                        header("location:../../system.php?link=menu-antrian-consultation");
		?>