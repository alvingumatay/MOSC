...
include '../config/database.php';
     $sql = mysql_query("SELECT nomor_antrian FROM `temp_hematology`
                                        WHERE id = '1'");
...
$detail = mysql_query("SELECT * FROM
                            loket
                            WHERE
                            nama_loket='HEMATOLOGY'");
$d    = mysql_fetch_array($detail);
$loket=$d[no_loket];
//Initialisasi nilai untuk nomor loket


$location_counter = "content/hematology/data.txt";
$location_date = "content/hematology/date.txt";
$itis = date ("d");
...
<audio id="suarabel" src="doorbell.mp3"></audio>
<audio id="suarabelnomorurut" src="rekaman/doorbell.mp3"  ></audio>
<audio id="suarabelsuarabelloket" src="rekaman/doorbell.mp3"  ></audio>

<audio id="belas" src="rekaman/doorbell.mp3"  ></audio>
<audio id="sebelas" src="rekaman/doorbell.mp3"  ></audio>
<audio id="puluh" src="rekaman/doorbell.mp3"  ></audio>
<audio id="sepuluh" src="rekaman/doorbell.mp3"  ></audio>
<audio id="ratus" src="rekaman/doorbell.mp3"  ></audio>
<audio id="seratus" src="rekaman/doorbell.mp3"  ></audio>
