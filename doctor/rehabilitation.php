...
<html lang = "en">
	<head>	
		<title>Consultation | Patient Record System</title>
		<meta charset = "UTF-8">
...
<br /><br /><br /><br /><br /><br /><br /><br />
 ...
 <div class = "panel panel-warning">
            ...
            <br/><br/>	
		<a href = "view_rehabilitation_record.php" id = "d_record" style = "float:right; margin-right:10px;" class = "btn btn-danger"><span class = "glyphicon glyphicon-book"></span> CONSULTATION RECORD</a>
		<br />
		<br />
		...
		<table id = "table" class = "display" cellspacing = "0" >
			...
			?>
				<tr>
					...
					<td>
						<center>
							<a href = "view_rehabilitation.php?itr_no=<?php echo $fetch['itr_no']?>"class = "btn btn-sm btn-success">
