  ...
  <div class="ts-main-content">
	<div class = "well">
		...
		<div class = "panel panel-default">
			<div class = "panel-heading">
				<label>URINALYSIS FORM</label>	<a style = "float:right; margin-top:-4px;" href = "urinalysis_pending.php?itr_no=<?php echo $_GET['itr_no']?>" class = "btn btn-success"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
			</div>
			...
			<div class = "panel-body">
				...
				<br />
				<div class = "form-inline">
					<button class = "btn btn-success" name = "save_u" ><span class = "glyphicon glyphicon-save"></span> SAVE</button>
				</div>
			</div>
