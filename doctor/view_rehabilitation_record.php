...
<html lang = "en">
  ...
  <center><p>Touch Screen left,right,up,down to see details.</p></center>
		...
		<a style = "float:right; margin-top:-4px;" href = "rehabilitation.php" class = "btn btn-success"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a> 
		<br />
		<br />
		<div class = "panel panel-success">
			<div class = "panel-heading">
				<h4>CONSULTATION RECORD LIST</h4>
			</div>
		</div>
		<br />
		<table id = "table" cellspacing = "0" class = "display">
			...
			?>
				<tr>
					...
					<td><center>
							<a href = "rehabilitation_record.php?itr_no=<?php echo $f['itr_no']?>&rehab_id=<?php echo $f['rehab_id'] ?>"class = "btn btn-success"><span class = "glyphicon glyphicon-book"></span> All Record</a> 
						</center></td>
				</tr>
			<?php
				}
